...
CRISP_TOKEN= # Crisp chat (legacy)
CRISP_IDENTIFIER= # Crisp plugin identifier (for migration)
CRISP_KEY= # Crisp plugin key (for migration)
CRISP_WEBSITE_ID= # Crisp website ID (for migration)
FRONT_INBOX_ID= # Front inbox ID to import Crisp conversations into
