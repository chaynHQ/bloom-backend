...
export class bloomBackend1643548072752 implements MigrationInterface {
    name = 'bloomBackend1643548072752'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "course_partner" ("createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "coursePartnerId" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" character varying NOT NULL, "partnerId" uuid, "courseId" uuid NOT NULL, CONSTRAINT "course_partner_index_name" UNIQUE ("partnerId", "courseId"), CONSTRAINT "PK_739b446c5c24fb11773a8e62331" PRIMARY KEY ("coursePartnerId"))`);
