...
export class bloomBackend1636413617255 implements MigrationInterface {
    name = 'bloomBackend1636413617255'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "partner_admin_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid, "partnerId" uuid, CONSTRAINT "REL_7622b92e51ebdd0ee3a77651df" UNIQUE ("userId"), CONSTRAINT "PK_053db2d5da6c9a732993bbf6ef5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "partner_access_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "activatedAt" TIMESTAMP, "featureLiveChat" boolean NOT NULL, "featureTherapy" boolean NOT NULL, "accessCode" character varying(6) NOT NULL, "therapySessionsRemaining" integer NOT NULL, "therapySessionsRedeemed" integer NOT NULL, "userId" uuid, "partnerId" uuid, "createdById" uuid, CONSTRAINT "UQ_f98c12f4abd111310ed15eb9666" UNIQUE ("accessCode"), CONSTRAINT "REL_713d3fd7cc1d63c926e98b876f" UNIQUE ("userId"), CONSTRAINT "PK_9536c21fc956ec857c4d5ef51cc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "partner_admin_entity" ADD CONSTRAINT "FK_7622b92e51ebdd0ee3a77651df8" FOREIGN KEY ("userId") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "partner_access_entity" ADD CONSTRAINT "FK_713d3fd7cc1d63c926e98b876f6" FOREIGN KEY ("userId") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "partner_access_entity" DROP CONSTRAINT "FK_713d3fd7cc1d63c926e98b876f6"`);
        await queryRunner.query(`ALTER TABLE "partner_admin_entity" DROP CONSTRAINT "FK_b2a8240d70de9ba235015286f77"`);
        await queryRunner.query(`ALTER TABLE "partner_admin_entity" DROP CONSTRAINT "FK_7622b92e51ebdd0ee3a77651df8"`);
