...
export class bloomBackend1675329251106 implements MigrationInterface {
  name = 'bloomBackend1675329251106';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "partner_feature" ADD CONSTRAINT "FK_91fa49f0f077d1d47ef581d458c" FOREIGN KEY ("partnerId") REFERENCES "partner"("partnerId") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
